<%-- 
    Document   : HVIServiceReportParamPage
    Created on : Jan 31, 2014, 8:57:51 PM
    Author     : Siaka
--%>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Household vulnerable Assessment report criteria </title>
        <style type="text/css">
<!--
a {
...
-->
    ...
    <body>
        <br/><br/>
        <center>
            <html:form action="/hVIServiceReportAction" method="post">
        ...
        <table class="paramPage">
            ...
            <tr><td class="orglabel" align="left"><jsp:include page="../includes/WardName.jsp" /> </td><td colspan="3">
                    <html:select property="ward" styleId="ward" style="width: 290px;" ><html:option value="All"> </html:option>
                        <logic:iterate id="wardObj" name="hhswardList">
            ...
            <tr><td class="title" align="left"><label style=" margin-right: 5px; color:white">To</label></td>
             ...
             <tr><td colspan="3" align="center"><html:submit property="hviReportBtn" value="Generate report" onclick="setActionName('hvisReportList')" style="width: 120px; margin-left: 70px;" /></td></tr>
        </table>
        </center>
        </span>
    <!--</div>-->
