<%-- 
    Document   : HVAAnalysisReportCriteriaPae
    Created on : Jul 17, 2014, 9:43:34 PM
    Author     : Siaka
--%>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Household vulnerable Assessment Analysis report criteria </title>
        <style type="text/css">
<!--
a {
...
-->
    ...
    <body>
        <br/><br/>
        <center>
            <html:form action="/hvaAnalysisReportAction" method="post">
                <html:hidden property="actionName" styleId="actionName"/>

        <span>
        <center>
        <table class="paramPage">
            <tr><td colspan="4" class="title" align="center">HVA analysis</td></tr>
            ...
            <tr><td class="orglabel" align="left">Enrollment status </td><td colspan="2">
                    <html:select property="enrollmentStatus" styleId="enrollmentStatus" style="width: 290px;" >
                        <html:option value="All">All</html:option>
                        <html:option value="currentlyEnrolled">Currently enrolled</html:option>
                        
                    </html:select> </td>
            </tr>
            <tr><td class="orglabel" align="left">Status type </td><td colspan="2">
                    <html:select property="statusType" styleId="statusType" style="width: 290px;" >
            ...
            <tr><td class="orglabel" align="left"> </td><td class="orglabel" colspan="2">
             ...
             <tr><td colspan="3" align="center"><html:submit property="hviReportBtn" value="Generate report" onclick="setActionName('hvaReport')" style="width: 150px; margin-left: 70px;" /></td></tr>
        </table>
        </center>
        </span>
    <!--</div>-->
