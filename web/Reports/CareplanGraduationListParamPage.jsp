<%-- 
    Document   : CareplanGraduationListParamPage
    Created on : Sep 26, 2017, 8:39:41 AM
    Author     : smomoh
--%>
    ...
    <body>
        ...
        <center>
            <html:form action="/careplanachievementreport" method="post">
                ...
                <html:hidden property="pageName" styleId="pageName" value="graduationListParamPage"/>
        <span>
        <center>
        <table class="paramPage">
            <tr><td colspan="4" class="title" align="center">Care plan graduation list</td></tr>
