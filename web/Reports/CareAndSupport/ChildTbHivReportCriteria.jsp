<%-- 
    Document   : ChildTbHivReportCriteria
    Created on : Jul 19, 2016, 1:56:16 PM
    Author     : smomoh
--%>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>TB/HIV screening checklist report criteria</title>
...
function disableComponents(id)
{
    ...
    <body>
        <br/><br/>
        <center>
            <html:form action="/ovctbhivScreeningAction" method="post">
        ...
        <table class="paramPage">
            <tr><td colspan="4" class="title" align="center">TB/HIV Checklist</td></tr>
            ...
            <td class="orglabel" align="left">Period</td>
                <td align="left">
                    ...
                    </html:select> <html:select property="endYear" style="width: 50px;" styleId="enrollmentEndYear" >
            ...
            <tr><td colspan="3" align="center"><html:submit value="Generate report" onclick="setActionName('summstatreport')" style="width: 120px; margin-left: 350px;" /></td></tr>
        </table>
        </center>
        </span>
   <!-- </div>-->
