<%-- 
    Document   : DhisExport
    Created on : Sep 15, 2011, 9:30:26 AM
    Author     : smomoh
--%>
...
-->
    ...
    <body>
        <center>
            <html:form action="/exporttodhis" method="post">
                <html:hidden property="actionName" styleId="actionName"/>
                
                <div styleId="sumstatDivPerMth" class="paramPage" style="height: 200px; width: 350px; margin-top: 100px;">
        <span>
        <center>
        <table >
            <tr><td colspan="4" class="title">DHIS export</td></tr>
            ...
            <tr><td colspan="3" align="center"><html:submit property="dhisExportBtn" value="Submit" onclick="setActionName('dhisexport')" style="width: 70px; margin-left: 70px;" /></td></tr>
        </table>
        </center>
        </span>
    </div>
