...
import com.fhi.nomis.nomisutils.ButtonStateBean;
 ...
 * @author smomoh
 */
public class HouseholdFollowupAssessmentForm extends org.apache.struts.action.ActionForm {
    ...
    private ButtonStateBean bsb=new ButtonStateBean();
    

    public HouseholdFollowupAssessmentForm()
    {
        super();
    ...
    public ButtonStateBean getBsb() {
        return bsb;
    }

    public void setBsb(ButtonStateBean bsb) {
        this.bsb = bsb;
    }
    ...
    private boolean isHouseholdAccessed()
    {
        ...
        if(getReasonWithdrawal()==null && (getReasonWithdrawal()==null && (getEducationLevel()==0 || getFoodSecurityAndNutrition()==0
         || getHealth()==0 || getMeansOfLivelihood()==0 || getShelterAndHousing()==0
