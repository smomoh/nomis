...
public class NationalHivRiskAssessmentAction extends org.apache.struts.action.Action {
            ...
            throws Exception 
    {
        ...
        NationalHivRiskAssessmentForm hraform=(NationalHivRiskAssessmentForm)form;
        ...
        else if(requiredAction.equalsIgnoreCase("assessmentDetails"))
        {
            ...
            if(ovc !=null)
            {
                ...
                if(hrac !=null)
                {
                    ...
                    hraform.setParentKnowHivStatusQuestion(hrac.getParentKnowHivStatusQuestion());
                    hraform.setParentKnowHivStatusComment(hrac.getParentKnowHivStatusComment());
                    hraform.setTbOrNutritionQuestion(hrac.getTbOrNutritionQuestion());
                    hraform.setTbOrNutritionComment(hrac.getTbOrNutritionComment());
                    hraform.setTeenMotherQuestion(hrac.getTeenMotherQuestion());
                    hraform.setTeenMotherComment(hrac.getTeenMotherComment());
                    hraform.setChildHeadedHhQuestion(hrac.getChildHeadedHhQuestion());
                    hraform.setChildHeadedHhComment(hrac.getChildHeadedHhComment());
                    hraform.setDiverseSexQuestion(hrac.getDiverseSexQuestion());
                    hraform.setDiverseSexComment(hrac.getDiverseSexComment());
...
private HivRiskAssessmentChecklist createNewHivRiskAssessmentChecklist(NationalHivRiskAssessmentForm hraform)
    {
        ...
        if(hraform !=null)
        {
            String childAtRisk="No";
                ...
                hrac.setParentKnowHivStatusQuestion(hraform.getParentKnowHivStatusQuestion());
                hrac.setParentKnowHivStatusComment(hraform.getParentKnowHivStatusComment());
                hrac.setTbOrNutritionQuestion(hraform.getTbOrNutritionQuestion());
                hrac.setTbOrNutritionComment(hraform.getTbOrNutritionComment());
                hrac.setTeenMotherQuestion(hraform.getTeenMotherQuestion());
                hrac.setTeenMotherComment(hraform.getTeenMotherComment());
                hrac.setChildHeadedHhQuestion(hraform.getChildHeadedHhQuestion());
                hrac.setChildHeadedHhComment(hraform.getChildHeadedHhComment());
                hrac.setDiverseSexQuestion(hraform.getDiverseSexQuestion());
                hrac.setDiverseSexComment(hraform.getDiverseSexComment());
    ...
    private boolean isChildAtRisk(HivRiskAssessmentChecklist hrac)
    {
        ...
        if(hrac !=null)
        {
            ...
            else if(hrac.getParentKnowHivStatusQuestion() !=null && hrac.getParentKnowHivStatusQuestion().trim().equalsIgnoreCase("Yes"))
            childAtRisk=true;
            else if(hrac.getChildHeadedHhQuestion() !=null && hrac.getChildHeadedHhQuestion().trim().equalsIgnoreCase("Yes"))
            childAtRisk=true;
            else if(hrac.getTbOrNutritionQuestion() !=null && hrac.getTbOrNutritionQuestion().trim().equalsIgnoreCase("Yes"))
            childAtRisk=true;
            else if(hrac.getTeenMotherQuestion() !=null && hrac.getTeenMotherQuestion().trim().equalsIgnoreCase("Yes"))
            childAtRisk=true;
            else if(hrac.getDiverseSexQuestion() !=null && hrac.getDiverseSexQuestion().trim().equalsIgnoreCase("Yes"))
            childAtRisk=true;
    ...
    private NationalHivRiskAssessmentForm setBaselineInfo(NationalHivRiskAssessmentForm hraform, Ovc ovc,HttpServletRequest request)
    {
        if(ovc !=null)
        {
            DaoUtil util=new DaoUtil();
