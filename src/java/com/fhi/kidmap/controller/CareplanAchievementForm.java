...
public class CareplanAchievementForm extends org.apache.struts.action.ActionForm {
    ...
    private int noOfChildrenEnrolled;
    ...
    public int getNoOfChildrenEnrolled() {
        return noOfChildrenEnrolled;
    }

    public void setNoOfChildrenEnrolled(int noOfChildrenEnrolled) {
        this.noOfChildrenEnrolled = noOfChildrenEnrolled;
    }
...
@Override
    public void reset(ActionMapping mapping, HttpServletRequest request)
    {
        ...
        hth_vcreftested="N/A";
        hth_hivOnArt="N/A";
        hth_hivdisclosed="N/A";
        hth_vcInneedOfHthServices="N/A";
        stb_hungryNoFood="No";
        stb_resiliency="N/A";
        stb_cgPartEconServ="N/A";
        stb_socEmotSupport="No";
        sft_vcsad="No";
        sft_vcreferredForCps="N/A";
        sft_vcSafeFromAbuse="N/A";
        sft_birthCert="N/A";
        sft_cgcompletedTwoModules="No";
        sft_childHeadedLinkedToServices="N/A";
        sch_schAttendance="N/A";
        sch_vcEnrolledInSecondarySch="N/A";
        sch_adolInVoctraining="N/A";
        sch_earlyChildCare="N/A";

        hth_hivknowledgeComment=null;
        hth_vchivriskComment=null;
        hth_vcreftestedComment=null;
        hth_hivOnArtComment=null;
        hth_hivdisclosedComment=null;
        hth_vcInneedOfHthServicesComment=null;
        stb_hungryNoFoodComment=null;
        stb_resiliencyComment=null;
        sft_vcsadComment=null;
        stb_cgPartEconServComment=null;
        stb_socEmotSupportComment=null;
        sft_vcreferredForCpsComment=null;
        sft_vcSafeFromAbuseComment=null;
        sft_birthCertComment=null;
        sft_cgcompletedTwoModulesComment=null;
        sft_childHeadedLinkedToServicesComment=null;
        sch_schAttendanceComment=null;
        sch_vcEnrolledInSecondarySchComment=null;
        sch_adolInVoctrainingComment=null;
        sch_earlyChildCareComment=null;
        noOfChildrenEnrolled=0;
        comment=null;
    }
    /**
    ...
    {
        //NomisDate ndate=new DateManager();ndate.isValidDate(hhSurname);
        ActionErrors errors = new ActionErrors();
        if(this.getActionName() !=null && (this.getActionName().equalsIgnoreCase("save") || this.getActionName().equalsIgnoreCase("modify")))
        {
            if(getHhUniqueId()==null || getHhUniqueId().length() <1)
