...
public class Charts extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        String type =(String) session.getAttribute("charttype");
        ...
        try {
            ...
            out.println("<HTML>");
out.println("<HEAD>");
out.println("<TITLE> " + charttitle + " </TITLE>");
out.println("</HEAD>");
out.println("<DIV ALIGN=\"CENTER\">");
out.println("<BODY BGCOLOR=\"#666666\">");
out.println("<P>");
out.println("<DIV>");
out.println("<IMG SRC=\"" + param
+ "?type=" + type + "\" BORDER=0 WIDTH=1080 HEIGHT=525/>");

System.err.println("<IMG SRC=\"" + param
+ "?type=" + type + "\" BORDER=0 WIDTH=1080 HEIGHT=525/>");
