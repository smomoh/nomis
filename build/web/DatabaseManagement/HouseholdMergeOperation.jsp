<%-- 
    Document   : HouseholdMergeOperation
    Created on : May 31, 2016, 1:02:54 PM
    Author     : smomoh
--%>
...
function confirmAction(action,val)
{
    ...
    <body>
        ...
        <table class="paramPage">
            ...
            <tr><td class="orglabel" align="left">Record </td><td colspan="3">
                    <html:select property="recordToLoad" styleId="recordToLoad" style="width: 290px;" >
                        
                      <html:option value="householdrecords">Household records</html:option>
                      <html:option value="caregiverrecords">Caregiver records</html:option>  
                    </html:select> </td>
            </tr>
    ...
    <tr><td style="border: none; text-align: left">
                        ...
                        <table
                            ...
                            <logic:iterate id="hviData" name="hviRecords">
                                ...
                                <tr align="left" bgcolor="#D7E5F2">
                                    ...
                                    <td width="4%">${hviData.baselineAssessmentScore}</td>
                                    <td width="10%">
                    ...
                    <logic:present name="caregiverList">
                            ...
                            <logic:iterate id="cgiver" name="caregiverList">
                                ...
                                <tr align="left" bgcolor="#D7E5F2">
                                    ...
                                    <td width="10%">
                                        <a href="householdMergeAction.do?id=${cgiver.caregiverId}" target="_blank"> View list of OVC</a>
                                    </td>
                                    <td width="7%">
        ...
        <tr><td align="center"><html:submit property="hhmReportBtn" value="${btnName}" onclick="confirmAction('merge','merge')" style="width: 150px; margin-left: 50px;" disabled="${hhmBtnDisabled}"/></td></tr>
     </table>
