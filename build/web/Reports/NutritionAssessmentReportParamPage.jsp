<%-- 
    Document   : NutritionAssessmentReportParamPage
    Created on : Jan 2, 2015, 6:07:20 PM
    Author     : smomoh
--%>
...
-->
    ...
    <body>
        <br/><br/>
        <center>
            <html:form action="/nutririonAssessmentReportAction" method="post">
        ...
        <table class="paramPage">
            ...
            <tr><td class="orglabel" align="left">Assessment No. </td><td colspan="2">
                    <html:select property="assessmentNo" styleId="assessmentNo" style="width: 290px;" >
                        ...
                        <logic:iterate id="assessmentNo" name="nassessmentNoList">
