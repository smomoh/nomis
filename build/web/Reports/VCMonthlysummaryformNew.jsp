...
<table border="0" cellpadding="0" cellspacing="0" style="border:1px black solid; margin-bottom:70px">
  ...
  <tr >
    ...
    <th width="4%" colspan="8" class="tdLine" style="font-size:16px"><div align="center">Male</div></th>
    <th width="2%" colspan="8" class="tdLine" style="font-size:16px"><div align="center">Female</div></th>
  ...
  <tr >
    ...
    <th width="2%" class="tdLine"><div align="center">18-24</div></th>
    <th width="2%" class="tdLine"><div align="center">25+</div></th>
    <th width="2%" class="tdLine"><div align="center">Female Total</div></th>
       ...
       <logic:iterate id="monthlySummCount" collection="${mthSummarySessionObj[0]}">
            <tr><td class="tdLine">${monthlySummCount[0]} </td>
                <td>${monthlySummCount[1]}</td><td>${monthlySummCount[2]} </td><td class="tdLine">${monthlySummCount[3]}</td><td>${monthlySummCount[4]}</td><td>${monthlySummCount[5]} </td><td class="tdLine">${monthlySummCount[6]}</td><td class="tdLine">${monthlySummCount[7]} </td><td class="tdLine">${monthlySummCount[8]} </td>
                <td>${monthlySummCount[9]} </td><td>${monthlySummCount[10]} </td><td class="tdLine">${monthlySummCount[11]} </td><td>${monthlySummCount[12]} </td><td>${monthlySummCount[13]} </td><td class="tdLine">${monthlySummCount[14]} </td><td class="tdLine">${monthlySummCount[15]}</td>
                <td>${monthlySummCount[16]}</td> <td class="tdLine">${monthlySummCount[17]} </td></tr>
       </logic:iterate>
   <logic:iterate id="monthlySummCount" collection="${mthSummarySessionObj[1]}">
            <tr><td class="tdLine">${monthlySummCount[0]} </td><td style="background-color:#808080"> </td><td style="background-color:#808080"> </td><td class="tdLine" style="background-color:#808080"> </td>
                ...
                <td style="background-color:#808080"> </td><td class="tdLine">${monthlySummCount[2]} </td>
                <td style="background-color:#808080"> </td><td style="background-color:#808080"> </td><td class="tdLine" style="background-color:#808080"> </td>
                <td style="background-color:#808080"> </td><td style="background-color:#808080"> </td><td style="background-color:#808080"> </td><td class="tdLine">${monthlySummCount[4]} </td>
