<%-- 
    Document   : ReferralReportParamPage
    Created on : Apr 3, 2014, 8:37:30 PM
    Author     : Siaka
--%>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Vulnerable Household referral report criteria </title>
        <style type="text/css">
<!--
a {
...
-->
    ...
    <body>
        <br/><br/>
        <center>
            <html:form action="/vulnerableHouseholdReferralAction" method="post">
        ...
        <table class="paramPage">
            ...
            <tr><td class="orglabel" align="left">CBO </td><td colspan="3">
                    <html:select property="organization" styleId="organization" style="width: 290px;" onchange="setActionName('ward'); forms[0].submit()">
                        <<html:option value="All">All</html:option>
            ...
            <tr><td class="title" align="left"><label style=" margin-right: 5px; color:white">To</label></td>
             ...
             <tr><td colspan="3" align="center"><html:submit property="reportBtn" value="Submit" onclick="setActionName('report')" style="width: 70px; margin-left: 70px;" /></td></tr>
        </table>
        </center>
        </span>
      </html:form>
