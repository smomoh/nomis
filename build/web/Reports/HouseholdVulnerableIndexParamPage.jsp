<%-- 
    Document   : HouseholdVulnerableIndexParamPage
    Created on : Jan 27, 2014, 9:16:31 PM
    Author     : Siaka
--%>
...
-->
    ...
    <body>
        <br/><br/>
        <center>
            <html:form action="/householdVulnerabilityIndexReportAction" method="post">
        ...
        <table class="paramPage">
            ...
            <tr><td class="orglabel" align="left">Sort by </td><td colspan="3">
                    <html:select property="sortOrder" styleId="sortOrder" style="width: 290px;" >
                      ...
                      <html:option value="active">Active status</html:option>  
                    </html:select> </td>
            </tr>
